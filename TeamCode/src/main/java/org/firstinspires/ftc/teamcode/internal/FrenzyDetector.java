...
public class FrenzyDetector implements Runnable {
    ...
    private String modelFileName = "ffbn.tflite";
    private String labelFileName = "ffbn.txt";
    ...
    public FrenzyDetector(HardwareMap hMap, LinearOpMode caller, Telemetry t) throws Exception {
        hardwareMap = hMap;
        this.caller = caller;
        telemetry = t;
        initDetector();
