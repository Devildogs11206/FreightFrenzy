...
public class LiftController extends RobotController {
    ...
    public void execute() {
        ...
        else if (gamepad2.dpad_up) robot.lift(HIGHGOAL);
        else if (gamepad2.dpad_right || gamepad2.dpad_left) robot.lift(MIDGOAL);
        else if (gamepad2.dpad_down) robot.lift(LOWGOAL);
